    ...
    <div className="presentacion">
      ...
      <div className="presentacion">
        ...
        <div className="contenido">
          <h2 className="titulocont">¿Quiénes somos?</h2>
          <p>
            Minga es una aplicación web para conectar trabajadores domésticos
            con clientes que requieren su servicio.
          </p>
          <h2 className="titulocont">Misión</h2>
          <p>
          ...
          <h2 className="titulocont">Visión</h2>
          <p>
